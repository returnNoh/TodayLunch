<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="beans.ForgetInfoDAO"%>
...
고객님의 아이디는<h3>${result}</h3>
			...
			<div class="tab-pane fade" id="PASS">
				...
				<form method="post" action="forget_Info.lunch">
					...
					찾으시려는 아이디와 이메일정보를 적어주세요.<br> <input type="text" name="id"
						placeholder="아이디를 적어주세요"><br> <input type="email"
						name="email" placeholder="이메일을 적어주세요"> <input
...
<h3>${result}</h3>
	...
	<!-- ID찾기 부분 -->
	<!-- <form method="post" action="TodayLunch/Login/forget_Info.lunch">
