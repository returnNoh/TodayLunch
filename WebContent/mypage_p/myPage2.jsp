								...
								<ul class="nav navbar-nav">
												...
												<div class="row">
													<div class="col-md-4 col-sm-4">
														...
														<div class="menu-item">
															...
															<!-- Button -->
															<a href="menu.html" class="btn btn-danger btn-xs">Buy</a>
														</div>
													</div>
													<div class="col-md-4 col-sm-4">
														<!-- Menu Item -->
														<div class="menu-item">
															...
															<img src="../img/dish/dish2.jpg" class="img-responsive"
																alt="" width="150px" height="150px" " />
															<!-- Button -->
															<a href="menu.html" class="btn btn-danger btn-xs">Go</a>
														</div>
													</div>
													<div class="col-md-4 col-sm-4">
														<!-- Menu Item -->
														<div class="menu-item">
															...
															<img src="../img/dish/dish3.jpg" class="img-responsive"
																alt="" width="150px" height="150px" "/>
															<!-- Button -->
															<a href="menu.html" class="btn btn-danger btn-xs">Check</a>
														</div>
													</div>
												</div>
											</li>
									...
									<li class="dropdown visible-xs"><a href="#"
										...
										<ul class="dropdown-menu">
											<li><a href="menu.html">Buy</a></li>
											<li><a href="menu.html">Check</a></li>
											<li><a href="menu.html">Personal</a></li>
										</ul></li>
									<li><a href="index.html"><img
											src="../img/nav-menu/nav1.jpg" class="img-responsive" alt="" />
											Shop List</a></li>
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-4 col-sm-offset-2">
								...
								<div class="shopping-item">
									...
									<h4 class="center">
										<a href="item-single.html">식권 구매</a>
									</h4>
							...
							<div class="col-md-3 col-sm-4">
								...
								<div class="shopping-item">
									...
									<!-- Shopping item name / Heading -->
									<h4 class="center">
										<a href="item-single.html">사용 내역</a>
									</h4>
									<!-- <span class="item-price pull-right"></span> -->
									<div class="clearfix"></div>
									...
									<!-- Buy now button -->
									<div class="visible-xs">
										<a class="btn btn-danger btn-sm" href="#">Check Now</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 col-sm-4">
								...
								<div class="shopping-item">
									...
									<!-- Shopping item name / Heading -->
									<h4 class="center">
										<a href="item-single.html">식권 사용</a>
									</h4>
									<!-- <span class="item-price pull-right"></span> -->
									<div class="clearfix"></div>
							...
							<div class="col-md-offset-3 col-md-3  col-sm-4">
								...
								<div class="shopping-item">
									...
									<!-- Shopping item name / Heading -->
									<h4 class="center">
										<a href="item-single.html">회원 수정</a>
									</h4>
									<!-- <span class="item-price pull-right"></span> -->
									<div class="clearfix"></div>
									...
									<!-- Buy now button -->
									<div class="visible-xs">
										<a class="btn btn-danger btn-sm" href="#">UPDATE PROFILE</a>
									</div>
								</div>
							</div>
							...
							<div class=" col-md-3  col-sm-4">
								...
								<div class="shopping-item">
									...
									<!-- Shopping item name / Heading -->
									<h4 class="center">
										<a href="item-single.html">회원 탈퇴</a>
									</h4>
									<!-- <span class="item-price pull-right"></span> -->
									<div class="clearfix"></div>
									...
									<!-- Buy now button -->
									<div class="visible-xs">
										<a class="btn btn-danger btn-sm" href="#">OUT</a>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6">
								...
								<div class="footer-widget">
									...
									<h4>Join Us Today</h4>
									<!-- Paragraph -->
									<p>There is no one who loves pain itself, who seeks after
										it and wants to have it.</p>
									<!-- Subscribe form -->
									<form role="form">
